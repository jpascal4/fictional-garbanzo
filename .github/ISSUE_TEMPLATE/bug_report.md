...
cmake .. -DBOOST_ROOT=/home/bloc/boost_1_59_0
make -j4
```

**If self compiled, please provide of your BLOC CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect zedwallet, BLOCd, bloc-service, miner? -->
