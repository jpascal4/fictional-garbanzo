...
size_t difficultyBlocksCountByBlockVersion(uint8_t blockMajorVersion, uint32_t height) const;
  ...
  bool checkProofOfWorkV1(Crypto::cn_pow_hash, const CachedBlock& block, uint64_t currentDifficulty) const;
  bool checkProofOfWorkV2(Crypto::cn_pow_hash, const CachedBlock& block, uint64_t currentDifficulty) const;
  bool checkProofOfWork(Crypto::cn_pow_hash, const CachedBlock& block, uint64_t currentDifficulty) const;
