...
bool Currency::checkProofOfWorkV1(Crypto::cn_pow_hash, const CachedBlock& block, uint64_t currentDifficulty) const {
...
bool Currency::checkProofOfWorkV2(Crypto::cn_pow_hash, const CachedBlock& cachedBlock, uint64_t currentDifficulty) const {
...
bool Currency::checkProofOfWork(Crypto::cn_pow_hash, const CachedBlock& block, uint64_t currentDiffic) const {
